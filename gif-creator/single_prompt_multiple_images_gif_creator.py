...
def get_animated_gif(prompt):
    ...
    generated_images = text_to_img_pipe(prompt=prompt, num_images_per_prompt=4, num_inference_steps=50, guidance_scale=7.5, generator=torch.Generator(device).manual_seed(42)).images
    ...
    export_to_gif(images, "images/single_prompt_output.gif", fps=3)
